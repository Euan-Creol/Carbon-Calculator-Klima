...
function determineInversion(buttonText) {
  if (buttonText !== 'Your Subscription') {
    return true
  }
  return false
}
export default function SubscriptionCard(props) {
  ...
  const {
    subscription, stripe, address, buttonText
  } = props
  ...
  const invertedValue = determineInversion(buttonText)
  return (
      ...
      <Card className="root">
        ...
        <CardContent>
          <Grid container direction="row" justify="center" spacing={0} alignItems="center">
            ...
            <Grid item xs={8} className="sub-btn-item">
              <StripeCheckoutButton
                plan={subscription.stripeCode}
                stripe={stripe}
                address={address}
            ...
            <Grid item xs={2} className="card-more-btn">
...
SubscriptionCard.propTypes = {
  subscription: PropTypes.shape({
    ...
    stripeCode: PropTypes.string.isRequired,
