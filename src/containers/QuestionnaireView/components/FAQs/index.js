...
class FAQs extends Component {
  ...
  render() {
    return (
      <div>
        <Card style={{
          padding: 32, borderRadius: '0.8rem'
        }}
        >
          <Grid
            container
          ...
          >
            <Grid item xs>
              <Accordion defaultExpanded style={{ marginBottom: 4 }}>
                <AccordionSummary
                ...
                <AccordionDetails>
                  <h4>
                    ...
                    Greenhouse Gases generated as a result of
                    one&apos;s actions.
                    tCO2e stands for 1 ton CO2 equivalent.
                    Whilst CO2 makes up a large proportion of
                    total emissions, other Greenhouse Gases
                    also have an tCO2e stands for 1 ton CO2
                    equivalent. Whilst CO2 makes up a large
                    proportion of total emissions, other
                    Greenhouse Gases also have an impact on
                    the climate. 1 ton of methane, for example,
                    has 29x the impact one ton of CO2 has,
                    so it is useful to factor in the total
